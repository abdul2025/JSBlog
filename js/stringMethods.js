...
// const categoTital = document.querySelector('.catego-tital');
// categoTital.addEventListener('click', function() {
//     const catgElem = categories.innerHTML =
//         `<li class="catego-tital">categories</li>
// <li class="categorey">
// <a href=""> html <i class="fa fa-html5"></i></a>
// </li>`;
// })
...
//     demo.innerHTML = `<div>Input : const str = ${input};</div><div>console.log(str.length);</div>`;
...
// const inputs = document.querySelectorAll('.str-input');
...
//         if (cur.className.includes('length')) {
//             let value = cur.value;
//             let output = value.length;
//             display(value, output);
//         } else if (cur.className.includes('trim')) {
...
// const btnLength = document.querySelector('.btn-length').addEventListener('click', test);
// const btnTrim = document.querySelector('.btn-trim').addEventListener('click', test);